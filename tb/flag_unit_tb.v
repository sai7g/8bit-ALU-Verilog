...
module flag_unit_tb;
    ...
    reg  [2:0] result_sel;
    wire       zero_flag, carry_flag, overflow_flag, negative_flag, parity_flag;
    ...
    initial begin
        ...
        // Arithmetic result, zero, with carry/overflow present
        final_result = 8'h00; arith_carry = 1'b1; arith_overflow = 1'b0; result_sel = 3'b000; #10;

        // Arithmetic result, negative (MSB set), odd parity value
